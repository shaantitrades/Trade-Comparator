-- ============================================
-- SCRIPT SQL POUR CRÉER/MODIFIER LA TABLE PLATFORMS
-- ============================================
-- Ce script peut être exécuté même si la table existe déjà
-- Il évite les erreurs de duplication
...
-- Créer la table platforms (si elle n'existe pas)
...
-- Créer le trigger (supprimer l'ancien s'il existe, puis créer le nouveau)
...
-- DÉSACTIVER RLS temporairement pour éviter les problèmes de permissions
-- Vous pouvez l'activer plus tard avec des politiques sécurisées
